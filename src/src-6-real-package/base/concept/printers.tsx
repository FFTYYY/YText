		...
		inner: (props: PrinterRenderFunctionProps<GroupNode>) => {
			...
			return <AutoStack force_direction="column">
				<PrinterDisplayText sx={{
					fontSize  : remtimes(theme?.printer?.fonts?.structure?.fontSize   as string , 1.4) , //字号翻倍
					lineHeight: remtimes(theme?.printer?.fonts?.structure?.lineHeight as string , 1.4) ,  //行高翻倍
